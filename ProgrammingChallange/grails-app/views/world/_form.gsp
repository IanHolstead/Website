...
<div class="control-group fieldcontain ${hasErrors(bean: worldInstance, field: 'title', 'error')} ">
	<label for="title" class="control-label"><g:message code="world.title.label"/></label>
	<div class="controls">
...
<div class="control-group fieldcontain ${hasErrors(bean: worldInstance, field: 'summary', 'error')} ">
	<label for="summary" class="control-label"><g:message code="world.summary.label"/></label>
	<div class="controls">
...
<div class="control-group fieldcontain ${hasErrors(bean: worldInstance, field: 'status', 'error')} ">
	<label for="status" class="control-label"><g:message code="world.status.label"/></label>
	<div class="controls">
...
<div class="control-group fieldcontain ${hasErrors(bean: worldInstance, field: 'video', 'error')} ">
	<label for="video" class="control-label"><g:message code="world.video.label"/></label>
	<div class="controls">
...
<div class="control-group fieldcontain ${hasErrors(bean: worldInstance, field: 'videoCaption', 'error')} ">
	<label for="videoCaption" class="control-label"><g:message code="world.videoCaption.label"/></label>
	<div class="controls">
...
<div class="control-group fieldcontain ${hasErrors(bean: worldInstance, field: 'xkcd', 'error')} ">
	<label for="xkcd" class="control-label"><g:message code="world.xkcd.label"/></label>
	<div class="controls">
...
<div class="control-group fieldcontain ${hasErrors(bean: worldInstance, field: 'xkcdCaption', 'error')} ">
	<label for="xkcdCaption" class="control-label"><g:message code="world.xkcdCaption.label"/></label>
	<div class="controls">
