...
<head>
	<title><g:message code="info.aboutMe.title" default="About Me"/></title>
	...
	<section id="intro-about">
		...
		<div class="about_text">
			...
			<p>
				...
				I grew up in Ottawa and went to Bishop Hamilton Montessori School and Colonel By 
				Secondary School; I took a year off to competitively cross country ski before heading off to university. 
				I enjoy exercising; cross country skiing, running and biking as physical activities as well as programming, gaming and puzzles.
			</p>
		</div>
		
	</section>

	<section id="additional-about">
		<h1><g:message code="about.faq.label"/></h1>
		<p>
			<div class="QA">
				<div class="question">
			...
			<div class="QA">
				...
				<div class="answer">
					I am a huge fan of the inheritance cycle (specifically Inheritance) but I also thoroughly enjoyed the entire Harry Potter series (Half Blood Prince was the best of the series). 
				</div>
			</div>
			<div class="QA">
				<div class="question">
			...
			<div class="QA">
				...
				<div class="answer">
					I carried the Olympic torch for the Vancouver 2010 Olympics! (In Ottawa)
				</div>
			</div>
			<div class="QA">
				<div class="question">
