...
@TestFor(ChallangesController)
@Mock(Challanges)
class ChallangesControllerTests {
    ...
    void testShow() {
        ...
        populateValidParams(params)
        def challanges = new Challanges(params)
    ...
    void testDelete() {
        ...
        assert Challanges.count() == 0
        assert Challanges.get(challanges.id) == null
        assert response.redirectedUrl == '/challanges/list'
    }
}
